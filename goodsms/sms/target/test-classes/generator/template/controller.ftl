...
public class ${modelNameUpperCamel}Controller extends BaseController{
    ...
    public Result add(@RequestBody ${modelNameUpperCamel} ${modelNameLowerCamel},HttpServletRequest request) {
    	...
    	try {
    		...
    		${modelNameLowerCamel}Service.${modelNameLowerCamel}Add(${modelNameLowerCamel},userId);
    ...
    @PostMapping("/update")
    public Result update(@RequestBody ${modelNameUpperCamel} ${modelNameLowerCamel},HttpServletRequest request) {
    	if(${modelNameLowerCamel} == null){
    		return ResultGenerator.genFailResult(ResultCode.OBJECT_IS_NULL);
    	}
    	...
    	try {
    		...
    		${modelNameLowerCamel}Service.${modelNameLowerCamel}Update(${modelNameLowerCamel},userId);
    ...
    @PostMapping("/list")
    public Result list(@RequestBody ${modelNameUpperCamel} ${modelNameLowerCamel}, @RequestParam(defaultValue = "1") Integer page, @RequestParam(defaultValue = "20") Integer size) {
