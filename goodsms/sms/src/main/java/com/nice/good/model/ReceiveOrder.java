...
public class ReceiveOrder {
    ...
    public Date getShelfTimeStart() {
        return shelfTimeStart;
    }

    public void setShelfTimeStart(Date shelfTimeStart) {
        this.shelfTimeStart = shelfTimeStart;
    }

    public Date getShelfTimeEnd() {
        return shelfTimeEnd;
    }

    public void setShelfTimeEnd(Date shelfTimeEnd) {
        this.shelfTimeEnd = shelfTimeEnd;
    }
    ...
    @Transient
    private List<ReceiveDetail> receiveDetails;
    ...
    // 全参构造函数
    public ReceiveOrder(String receiveId, String receiveCode, String gooderCode, String gooderName, String orgCode,
                        String orgName, String receiveType, Integer orderStatus, Date appointTime, String providerCode,
                        String providerName, String purchaseCode, String outsideCode, String platformCode, String carrierCode,
                        String carrierName, String carNum, String driver, String telephone, String platformType, Integer expectNum,
                        Integer receiveNum, Integer refuseNum, Integer shelfNum, Integer qualityNum, Integer secondNum, Date clearTime,
                        Double predictBulk, Double predictWeight, Date lastShelfTime, Date lastReceiveTime, Date lastQualityTime,
                        String statement, Integer hangUp, String createId, Date createDate, String modifyId, Date modifyDate, Date appointTimeStart,
                        Date appointTimeEnd, Date createTimeStart, Date createTimeEnd, Date receiveTimeStart, Date receiveTimeEnd,
                        Date qualityTimeStart, Date qualityTimeEnd, String goodCode, String goodName, Date shelfTimeStart, Date shelfTimeEnd,
    ...
    public String toString() {
        return "ReceiveOrder{" +
                ...
                ", qualityTimeEnd=" + qualityTimeEnd +
                ", goodCode='" + goodCode + '\'' +
                ", goodName='" + goodName + '\'' +
                ", shelfTimeStart=" + shelfTimeStart +
