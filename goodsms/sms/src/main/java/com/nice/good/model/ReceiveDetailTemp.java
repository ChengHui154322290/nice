...
@Table(name = "o_receive_detail_temp")
public class ReceiveDetailTemp {
    /**
     * 主键收货单明细id,后台生成
     */
    @Id
    ...
    /**
     * 货品标记,上架保存时原有记录一分为二 2表示正品,3表示次品
     */
    @Transient
     ...
     */
    @Transient
    private String shelfSeatCode;


    public String getShelfSeatCode() {
        return shelfSeatCode;
    }

    public void setShelfSeatCode(String shelfSeatCode) {
        this.shelfSeatCode = shelfSeatCode;
    }
