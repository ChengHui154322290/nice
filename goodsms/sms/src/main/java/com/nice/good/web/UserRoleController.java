...
public class UserRoleController extends BaseController {
    ...
    @PostMapping("/add")
    public Result add(@RequestBody UserRole userRole,HttpServletRequest request) {
    	if(userRole == null){
    	...
    	try {
    		...
    		userRoleService.userRoleAdd(userRole,userId);
    ...
    @PostMapping("/update")
    public Result update(@RequestBody UserRole userRole,HttpServletRequest request) {
    	if(userRole == null){
    		return ResultGenerator.genFailResult(ResultCode.OBJECT_IS_NULL);
    	}
    	...
    	try {
    		...
    		userRoleService.userRoleUpdate(userRole, userId);
    ...
    @PostMapping("/list")
    public Result list(@RequestBody UserRole userRole, @RequestParam(defaultValue = "1") Integer page, @RequestParam(defaultValue = "20") Integer size) {
